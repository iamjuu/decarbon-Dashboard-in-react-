  ...
  try{
    const response = await Axios.get('/usercountdetails');
  ...
  console.log(error)
    setError('Failed to load usercount data.');
  }
          ...
          <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
            ...
            >
              <StatCard
                ...
                icon={UsersIcon}
                value={countobject?.regcount ?? "Loading..."}
                color="#6366F1"
              />
              <StatCard
                name="Pending Bills"
                icon={UserPlus}
                value={countobject?.pendingbills ?? "Loading..."}
                color="#b91010"
              />
              <StatCard
                name="Enqury Clients"
                icon={UserCheck}
                value={countobject?.enquiryClients ?? "Loading..."}
                color="#F59E0B"
              />
              <StatCard
                name="Total Services"
                icon={Car } 
                value={countobject?.totalServices ?? "Loading..."}
                color="#10B981"
              />
            </motion.div>
